...
## [2.1.1]
### Fixed
- Fix xml resolve class alias [#14](https://github.com/cdgeass/my-mybatis-plugin/issues/14)
- Fix generator loss field
- 修复了 xml 中类别名的解析 [#14](https://github.com/cdgeass/my-mybatis-plugin/issues/14)
- 修复了 mbg 会丢失字段的问题
